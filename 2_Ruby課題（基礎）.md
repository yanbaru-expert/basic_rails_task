...
まずは, 以下の教材を参考に Ruby, Ruby on Rails のローカル環境を構築して下さい。

- [Ruby on Rails の環境構築（Mac 版・Intel）](https://www.yanbaru-code.com/texts/208)
- [Ruby on Rails の環境構築（Mac 版・Apple Silicon）](https://www.yanbaru-code.com/texts/569)

なお, Intel か Apple Silicon か分からない場合は, ターミナルで以下を実行して確認して下さい。
...
1. [課題リポジトリ](https://github.com/yanbaru-expert/basic_rails_task) にアクセス
2. 「Fork」をクリック
